<html>
    <head>
        ...
        <link href="<?php echo base_url()?>assets/moje_slozka/bootstrap.min.css" rel="stylesheet" type="text/css">
        <link href="<?php echo base_url()?>assets/moje_slozka/moje.css" rel="stylesheet" type="text/css">
